...
import { userLogin,userGLogin} from '../auth/api';
...
function LoginForm({
  ...
  const handleLoginSuccess = (credentialResponse) => {
    handleGLogin(credentialResponse);
  };
...
export default function LoginPage() {
  ...
  const handleGLogin = async (requestData) => {
    try {
      const data = await userGLogin(requestData);
      console.log(data);
      if (data.error === false) {
        ...
        <Container maxWidth="xs">
          <ContentOverlay>
            <StyledContent>
              ...
              <LoginForm handleGLogin={handleGLogin} username={username} onRecaptchaChange={onRecaptchaChange} isCaptchaSuccessful={isCaptchaSuccessful} captchaRef={captchaRef} password={password} handleLogin={handleLogin} showPassword={showPassword} setPassword={setPassword} setUsername={setUsername} setShowPassword={setShowPassword} />
            </StyledContent>
          </ContentOverlay>
        </Container>
        <Snackbar
