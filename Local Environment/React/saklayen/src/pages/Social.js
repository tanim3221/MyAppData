...
import { Container, Button, TableContainer, Paper, Table, TableHead,FormControl,InputLabel,MenuItem,Select, TableRow, TableCell, TableBody, Dialog, DialogContent, TextField, CircularProgress, Snackbar, DialogTitle, Box, Stack, IconButton } from '@mui/material';
  ...
  const renderDialog = () => {
    return (
      <Dialog open={open} onClose={handleClose}>
        <DialogTitle>{isAdding ? 'Add New Social Link' : mainData.name}</DialogTitle>
        <DialogContent>
          <Box 
            component="form"
            sx={{
