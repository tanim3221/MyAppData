...
export default function Home() {
  ...
  const cardData = [
    ...
    { id: 4, title: 'Firm Analysis', click: '', icon: <Business fontSize="large"/>, count: <Insights fontSize="large"/> },
    { id: 5, title: 'Years to CA', click: '', icon: <School fontSize="large"/>, count: <Insights fontSize="large"/> },
