...
try:
    ...
    # Find the "registrationNo" input field and enter the value
    registration_no_input = driver.find_element_by_css_selector('input[formcontrolname="registrationNo"]')
    registration_no_input.send_keys("33371")

    # Find and click the "Go" button
    go_button = driver.find_element_by_css_selector('button.btn.btn-block')
    go_button.click()
